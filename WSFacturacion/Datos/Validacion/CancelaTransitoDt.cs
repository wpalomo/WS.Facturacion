...
{
    public class CancelaTransitoDt
    {
        /// ***********************************************************************************************
        /// <summary>
        /// lista de anomalias de tipo Cancelacion Transito
        /// </summary>
        ...
        public static DataSet getAnomalias(Conexion oConn, int codAnomalia, ParteValidacion parte, bool puedeVerValInvisible)
        {
            ...
            dsAnomalias.DataSetName = "CancelaTransito_AnomaliasDS";
            try
            {
                ...
                oCmd.CommandText = "Validacion.usp_CancelaTransito_getAnomalias";
        ...
        public static void setAnomaliasValidadas(Conexion oConn, int codAnomalia, int estacion, int parte, DateTime jornada, AnomaliaValidacionL anomalias, string validador)
        {
            try
            {
                ...
                foreach (AnomaliaValidacion item in anomalias)
                {
                    ...
                    if (item.EjeAdicionalTabulado != 0) rec.SetInt32(33, Convert.ToInt32(item.EjeAdicionalTabulado)); else rec.SetDBNull(33);
                    if (item.EjeAdicionalConsolidado != 0) rec.SetInt32(34, Convert.ToInt32(item.EjeAdicionalConsolidado)); else rec.SetDBNull(34);
