...
namespace Telectronica.Tesoreria
{
    ...
    /// </summary>
    /// ***********************************************************************************************
    public class RptListadoApropiacionesDt
    {
        /// ***********************************************************************************************
        /// <summary>
        ...
        /// ***********************************************************************************************
        public static DataSet getDepositosReporte(Conexion oConn,
                DateTime? jornadaDesde, DateTime? jornadaHasta,
                int? zona, int? estacion, int? turnoDesde, int? turnoHasta, int? bolsa)
        {
            DataSet dsPartes = new DataSet();
            dsPartes.DataSetName = "RptApropiaciones_ListadoApropiacionesDs";
            ...
            try
            {
                ...
                oCmd.CommandText = "Tesoreria.usp_RptApropiaciones_getApropiaciones";
                ...
                oDA.Fill(dsPartes, "Apropiaciones");
